...
def s_d(lowe_ratio,searchMode,MODE_RANSAC,DRAW_BOUNDING_BOX,SOURCE_IMAGE1,SOURCE_IMAGE2):
    DEBUG = False
...
s_d(lowe_ratio, searchMode, MODE_RANSAC, DRAW_BOUNDING_BOX,SOURCE_IMAGE1,SOURCE_IMAGE2)